...
class LLMConfig:
    def __init__(self):
        self.model_pretrained_model_name_or_path = os.getenv("LLM_PRETRAINED_MODEL_NAME_OR_PATH", "meta-llama/Llama-3.1-8B")
        self.model_type = os.getenv("LLM_MODEL_TYPE", "llama")
        self.model_file = os.getenv("LLM_MODEL_FILE", None)
